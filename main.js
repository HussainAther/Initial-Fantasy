import { battle } from './src/battle.ts'; // Import the battle module
...
function initiateBattle() {
  // Create instances of a character and an enemy
...
function handleOption1() {
  ...
  initiateBattle(); // Initiate the battle
}
...
function handleNextDialog() {
  switch (currentDialogState) {
    ...
    case "village":
      ...
      break;
    default:
      displayDialog("The journey ends here. You've reached the 7-11 and found the slurpee you've dreamed of! Thanks for playing!");
